...
## Version 11.2 cloud-control fix
Firebase SDK files now load dynamically after the app UI initializes. This prevents blocked or slow Firebase CDN requests from disabling the Cloud Sync buttons.
