...
function programForDate(date){
  return (date && date < PROGRAM_EFFECTIVE_DATE) ? LEGACY_PROGRAM : CURRENT_PROGRAM;
}
...
function programVersionLabel(date){
  return (date && date < PROGRAM_EFFECTIVE_DATE)
    ? 'Five-day program (legacy schedule)'
    : 'Four-day program (effective August 17, 2026)';
}
